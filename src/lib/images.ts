...
/** Tiny wine-tinted blur placeholder (#2b0710) for Next/Image while photos load. */
export const BLUR_DATA_URL =
  "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAADElEQVR4nGPQZhcAAACjAEMVNnSzAAAAAElFTkSuQmCC";
