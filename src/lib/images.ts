...
export const IMAGES = {
  ...
  waxProducts: {
    lycon: {
      src: "/images/waxing/lycon-pinkini.jpg",
      alt: "Lycon Australia Pinkini Brazilian Hybrid Hot Wax",
      brand: "Lycon",
      origin: "Australia",
      flag: "🇦🇺",
      type: "Gentle Stripless Hot Wax",
      formula: "Pinkini & Superberry",
      badge: "Premium Hot Wax",
      tagline: "For delicate, sensitive & intimate zones",
      description:
        "Australia's world renowned soothing hot wax formulated with chamomile and rose. Grips the hair directly rather than pulling delicate skin.",
      areas: ["Face & Eyebrows", "Underarms", "Bikini & Brazilian"],
      accent: "rose",
    },
    rica: {
      src: "/images/waxing/rica-white-chocolate.jpg",
      alt: "Rica Italy White Chocolate Liposoluble Strip Wax",
      brand: "Rica",
      origin: "Italy",
      flag: "🇮🇹",
      type: "Natural Liposoluble Strip Wax",
      formula: "White Chocolate",
      badge: "Luxury Strip Wax",
      tagline: "For gentle, flawless body waxing",
      description:
        "Crafted in Italy with 98% natural origin ingredients. Colophony free and infused with cocoa butter for exceptionally smooth, nourished results.",
      areas: ["Full Arms", "Full Legs", "Back & Chest", "Body Areas"],
      accent: "amber",
    },
    brazilGold: {
      src: "/images/waxing/brazil-gold.jpg",
      alt: "Brazil Gold Professional Depilatory Body Wax",
      brand: "Brazil Gold",
      origin: "Salon Standard",
      flag: "✨",
      type: "Golden Polymer Body Wax",
      formula: "Honey & Essential Oils",
      badge: "Standard Body Wax",
      tagline: "Reliable, smooth standard body wax option",
      description:
        "A trusted, smooth salon standard formula providing high adhesion with clean removal. Perfect for routine body waxing and maintenance.",
      areas: ["Everyday Arms", "Legs", "Routine Maintenance"],
      accent: "gold",
    },
  },
  socialProof: {
