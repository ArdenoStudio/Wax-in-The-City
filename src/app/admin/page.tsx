      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-6 border-b border-warm-border pb-8 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="mt-5 max-w-3xl font-sans text-h1 font-semibold tracking-tight text-warm">
        ...
        {!supabaseReady && (
          <div className="studio-plate mt-8 rounded-card p-6">
            <h2 className="font-sans text-h3 font-semibold text-warm">Connect Supabase admin access</h2>
        ...
        {supabaseReady && services.length === 0 && (
          <div className="studio-plate mt-8 rounded-card p-6">
            <h2 className="font-sans text-h3 font-semibold text-warm">No services in Supabase yet</h2>
  ...
  return (
    <section className="flex min-h-screen items-center justify-center bg-brand px-5 py-20 text-cream">
      ...
      <div className="glass-panel relative w-full max-w-md rounded-card p-6">
        ...
        <h1 className="mt-5 text-center font-sans text-h2 font-semibold tracking-tight text-cream">
          Admin access
        </h1>
