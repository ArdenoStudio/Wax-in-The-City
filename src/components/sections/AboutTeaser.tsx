...
export function AboutTeaser() {
  return (
    <section className="relative overflow-hidden bg-cream px-5 py-section-lg lg:px-8">
      <span aria-hidden className="pointer-events-none absolute left-6 top-6 select-none font-serif text-8xl font-light leading-none text-warm/[0.035] sm:text-9xl lg:left-12 lg:text-9xl">02</span>
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
        <motion.div
          ...
          className="group premium-surface micro-lift relative aspect-[4/5] overflow-hidden rounded-2xl p-2 sm:aspect-[5/4] lg:aspect-[4/5]"
        >
          <div className="relative z-10 h-full overflow-hidden rounded-card">
            <Image
          ...
          <div className="glass-panel absolute bottom-5 left-5 z-20 max-w-xs rounded-card p-5 text-cream">
            ...
            <p className="mt-2 font-serif text-h4 font-medium text-cream text-pretty">
        ...
        >
          ...
          <p className="mt-6 max-w-md text-body-lg text-warm-grey text-pretty">
