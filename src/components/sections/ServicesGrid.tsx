            ...
            return (
              <motion.div key={cat.slug} variants={fadeUp}>
                <Link
                  ...
                  className={cn("group relative z-10 grid gap-5 rounded-2xl p-5 transition-all duration-500 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-action/40 focus-visible:ring-offset-2 focus-visible:ring-offset-cream sm:grid-cols-[76px_1fr_auto] sm:items-center sm:p-6", tone.row)}
                >
